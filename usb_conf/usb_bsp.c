...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  //RCC_APB1PeriphResetCmd(RCC_APB1Periph_PWR, ENABLE); 	/* wtf? why? comment by akospasztor */
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_PWR, ENABLE);		/* use this instead */
...
void USB_OTG_BSP_EnableInterrupt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  /* PriorityGroup is set to 1 in main! --- HS ITs are configured into group 2, because currently HS isn't used */
